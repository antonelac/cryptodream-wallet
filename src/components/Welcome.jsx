...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input 
        ...
        className="my-2 w-full rounded-sm p-2 outline-none bg-transparent font-semibold text-white border-none text-lg blue-glassmorphism"
    />
);
            ...
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10">
                   ...
                   <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                       Explore Dream Crypto World. Buy and sell cryptocurrencies easily.
                   </p>
                    <button
                       type="button"
                       onClick= "ConnectWallet"
                       className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:[#2546bd]"
                      >
